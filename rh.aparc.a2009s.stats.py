...
KAO = pd.read_csv("AI_re/rh.aparc.a2009s.stats.csv")
AI = pd.read_csv("AI new/rh.aparc.a2009s.stats.csv")
...
KAO_AI.to_csv("AI_RESULT/AI_AI/AI_AI_rh.aparc.a2009s.stats.csv", index = False)

KAO_part = KAO_AI.loc[: , "G_and_S_frontomargin-NumVert_KAO" : "S_temporal_transverse-CurvInd_KAO"]
AI_part = KAO_AI.loc[: , "G_and_S_frontomargin-NumVert_AI" : "S_temporal_transverse-CurvInd_AI"]
...
rh_aparc_a2009s_stats = pd.DataFrame([Mean_KAO,sd_KAO,Mean_AI,sd_AI,Mean_Diff,Mean_Diff_Percentage,
...
rh_aparc_a2009s_stats.columns = ['Mean_AI_re','sd_AI_re','Mean_AI','sd_AI','Mean_Diff','Mean_Diff_%',
...
for i in KAO_part.columns:
    df_index.append(i[: -4])
rh_aparc_a2009s_stats.index = df_index
rh_aparc_a2009s_stats.index.name = "Structure"
    
rh_aparc_a2009s_stats.fillna("NaN", inplace=True)

rh_aparc_a2009s_stats.to_csv("AI_RESULT/COMPARISON/comparison_rh.aparc.a2009s.stats.csv")
