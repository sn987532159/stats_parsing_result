...
KAO = pd.read_csv("AI_re/rh.aparc.stats.csv")
AI = pd.read_csv("AI new/rh.aparc.stats.csv")
...
KAO_AI.to_csv("AI_RESULT/AI_AI/AI_AI_rh.aparc.stats-GrayVol.csv", index = False)
...
rh_aparc_stats = pd.DataFrame([Mean_KAO,sd_KAO,Mean_AI,sd_AI,Mean_Diff,Mean_Diff_Percentage,
...
rh_aparc_stats.columns = ['Mean_AI_re','sd_AI_re','Mean_AI','sd_AI','Mean_Diff','Mean_Diff_%',
...
for i in KAO_part.columns:
    df_index.append(i[: -4])
rh_aparc_stats.index = df_index
rh_aparc_stats.index.name = "Structure"
    
rh_aparc_stats.fillna("NaN", inplace=True)

rh_aparc_stats.to_csv("AI_RESULT/COMPARISON/comparison_rh.aparc.stats-GrayVol.csv")
...
KAO_AI.to_csv("AI_RESULT/AI_AI/AI_AI_rh.aparc.stats-ThickAvg.csv", index = False)
...
rh_aparc_stats.to_csv("AI_RESULT/COMPARISON/comparison_rh.aparc.stats-ThickAvg.csv")
