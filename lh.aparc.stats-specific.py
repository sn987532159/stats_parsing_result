...
KAO = pd.read_csv("AI_re/lh.aparc.stats.csv")
AI = pd.read_csv("AI new/lh.aparc.stats.csv")
...
columns_selected = ['patient ID', 'bankssts-GrayVol', 'caudalanteriorcingulate-GrayVol',
                    'caudalmiddlefrontal-GrayVol', 'cuneus-GrayVol', 'entorhinal-GrayVol',
                    'fusiform-GrayVol', 'inferiorparietal-GrayVol', 'inferiortemporal-GrayVol',
                    'isthmuscingulate-GrayVol', 'lateraloccipital-GrayVol', 'lateralorbitofrontal-GrayVol',
                    'lingual-GrayVol', 'medialorbitofrontal-GrayVol', 'middletemporal-GrayVol', 
                    'parahippocampal-GrayVol', 'paracentral-GrayVol', 'parsopercularis-GrayVol',
                    'parsorbitalis-GrayVol', 'parstriangularis-GrayVol', 'pericalcarine-GrayVol',
                    'postcentral-GrayVol', 'posteriorcingulate-GrayVol', 'precentral-GrayVol',
                    'precuneus-GrayVol', 'rostralanteriorcingulate-GrayVol', 'rostralmiddlefrontal-GrayVol',
                    'superiorfrontal-GrayVol', 'superiorparietal-GrayVol', 'superiortemporal-GrayVol', 
                    'supramarginal-GrayVol', 'frontalpole-GrayVol', 'temporalpole-GrayVol',
                    'transversetemporal-GrayVol', 'insula-GrayVol']
AI = AI[columns_selected]
KAO = KAO[columns_selected]

KAO_AI = pd.merge(KAO, AI, how = 'inner', on = "patient ID", suffixes = ("_KAO", "_AI"))

KAO_AI.to_csv("AI_RESULT/AI_AI/AI_AI_lh.aparc.stats-GrayVol.csv", index = False)

KAO_part = KAO_AI.loc[: , "bankssts-GrayVol_KAO" : "insula-GrayVol_KAO"]
AI_part = KAO_AI.loc[: , "bankssts-GrayVol_AI" : "insula-GrayVol_AI"]
...
lh_aparc_stats = pd.DataFrame([Mean_KAO,sd_KAO,Mean_AI,sd_AI,Mean_Diff,Mean_Diff_Percentage,
...
lh_aparc_stats.columns = ['Mean_AI_re','sd_AI_re','Mean_AI','sd_AI','Mean_Diff','Mean_Diff_%',
...
for i in KAO_part.columns:
    df_index.append(i[: -4])
lh_aparc_stats.index = df_index
lh_aparc_stats.index.name = "Structure"
    
lh_aparc_stats.fillna("NaN", inplace=True)

lh_aparc_stats.to_csv("AI_RESULT/COMPARISON/comparison_lh.aparc.stats-GrayVol.csv")
...
columns_selected = ['patient ID', 'bankssts-ThickAvg', 'caudalanteriorcingulate-ThickAvg',
                    'caudalmiddlefrontal-ThickAvg', 'cuneus-ThickAvg', 'entorhinal-ThickAvg',
                    'fusiform-ThickAvg', 'inferiorparietal-ThickAvg', 'inferiortemporal-ThickAvg',
                    'isthmuscingulate-ThickAvg', 'lateraloccipital-ThickAvg', 'lateralorbitofrontal-ThickAvg',
                    'lingual-ThickAvg', 'medialorbitofrontal-ThickAvg', 'middletemporal-ThickAvg', 
                    'parahippocampal-ThickAvg', 'paracentral-ThickAvg', 'parsopercularis-ThickAvg',
                    'parsorbitalis-ThickAvg', 'parstriangularis-ThickAvg', 'pericalcarine-ThickAvg',
                    'postcentral-ThickAvg', 'posteriorcingulate-ThickAvg', 'precentral-ThickAvg',
                    'precuneus-ThickAvg', 'rostralanteriorcingulate-ThickAvg', 'rostralmiddlefrontal-ThickAvg',
                    'superiorfrontal-ThickAvg', 'superiorparietal-ThickAvg', 'superiortemporal-ThickAvg', 
                    'supramarginal-ThickAvg', 'frontalpole-ThickAvg', 'temporalpole-ThickAvg',
                    'transversetemporal-ThickAvg', 'insula-ThickAvg']
AI = AI[columns_selected]
KAO = KAO[columns_selected]

KAO_AI = pd.merge(KAO, AI, how = 'inner', on = "patient ID", suffixes = ("_KAO", "_AI"))

KAO_AI.to_csv("AI_RESULT/AI_AI/AI_AI_lh.aparc.stats-ThickAvg.csv", index = False)

KAO_part = KAO_AI.loc[: , "bankssts-ThickAvg_KAO" : "insula-ThickAvg_KAO"]
AI_part = KAO_AI.loc[: , "bankssts-ThickAvg_AI" : "insula-ThickAvg_AI"]
...
lh_aparc_stats.to_csv("AI_RESULT/COMPARISON/comparison_lh.aparc.stats-ThickAvg.csv")
